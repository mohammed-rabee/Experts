        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left mb-2 mb-md-0">
                    <h1 class="breadcrumb-title mb-0 text-white">Your Account need to be activated</h1>
                </div>
                <div class="col-md-6">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <div class="section-title">
                        ...
                        <p>your account need to be activated , please contact with webiste owners to active it</p>
                        <p>the Conatct details is mentioned below</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
