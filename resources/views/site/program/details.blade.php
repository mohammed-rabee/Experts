                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="8" minlength="10"
                                                                ...
                                                                id="annoncment" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-header" id="headingOneadd___{{ $section->id }}">
                                            <h5 class="accordion-title mb-0">
                                                <button class="btn btn-link d-flex align-items-center ml-auto"
                                                    ...
                                                    aria-expanded="true"
                                                    aria-controls="collapseOneadd___{{ $section->id }}">Browse Section
                                                    Documents
                                                </button>
                                            </h5>
                                        </div>
                ...
                @if ($registred == true && $registerButNotActive == false)
                    @if (!$sessions->isEmpty())
                        @foreach ($sessions as $session)
                            <div>
                                <div class="accordion" id="accordion_{{ $session->id }}" style="padding-top: 4%">
                                    <div class="card">
                                        <div class="card-header" id="headingOne_{{ $session->id }}">
                                            <h5 class="accordion-title mb-0">
                                                <button class="btn btn-link d-flex align-items-center ml-auto"
                                                    data-toggle="collapse" data-target="#collapseOne_{{ $session->id }}"
                                                    aria-expanded="true"
                                                    aria-controls="collapseOne_{{ $session->id }}">{{ $session->name }}
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapseOne_{{ $session->id }}" class="collapse accordion-content"
                                            aria-labelledby="headingOne_{{ $session->id }}"
                                            data-parent="#accordion_{{ $session->id }}">
                                            <div class="card-body">
                                                <div class="row">
                            ...
                            <div class="card-header" id="headingOne">
                                <h5 class="accordion-title mb-0">
                                    <button class="btn btn-link d-flex align-items-center ml-auto" data-toggle="collapse"
                                        data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">You need
